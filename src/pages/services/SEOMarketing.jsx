...
import ServiceExtraContent from '../../components/common/ServiceExtraContent';
import { serviceVideos } from '../../data/serviceVideos';
import { serviceExtraContent } from '../../data/serviceExtraContent';
...
const SEOMarketing = () => {
  ...
  return (
    <div className="service-detail-page">
            ...
            <div className="col-12 col-md-6">
              <div className="service-image">
                <video autoPlay loop muted playsInline>
                  <source src="/sep.mp4" type="video/mp4" />
                </video>
              </div>
            </div>
          </div>
      ...
      <ServiceExtraContent {...serviceExtraContent['/services/seo-marketing']} />
